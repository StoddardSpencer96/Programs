...
namespace CurrenciesAPI.Controllers
{
    ...
    public class CountriesController : ControllerBase
    {
        ...
        public CountriesController(CurrenciesDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PostCountries([FromBody] Countries countries)
        {
            ...
            {
                if (CountriesExists(countries.CountryCode))
                {
            ...
            return CreatedAtAction("GetCountries", new { id = countries.CountryCode }, countries);
        }
